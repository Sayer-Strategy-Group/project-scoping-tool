...
- **Assumption:** Follow-up call with the client's data/ERP owners resolves extraction feasibility and data architecture direction
...
### D2: Price at lower-middle of the EL's verbal range
- **Category:** pricing
- **Decision:** Target $18,150 median against the EL's $15K-$30K verbal quote
- **Alternatives considered:** Price at midpoint ($22.5K) -- rejected, the budget owner is cost-conscious and wasn't in discovery; price at floor ($15K) -- rejected, leaves no margin for real estate pipeline unknowns
- **Rationale:** The budget owner controls spend but wasn't in detailed discovery. Lower-middle builds trust while leaving $5K+ buffer for scope additions. The champion is not the decision-maker.
- **Assumption:** Real estate pipeline discovery with the client's stakeholders doesn't add >20 hrs of work
