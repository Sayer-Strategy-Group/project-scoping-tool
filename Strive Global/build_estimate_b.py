...
ws1.cell(row=1, column=1, value='STRIVE Global -- Full CRM Overhaul: Approach Comparison').font = TITLE_FONT
...
# Phase 1 label
ws2.cell(row=4, column=1, value='PHASE 1: CRM FOUNDATION (Weeks 1-6)').font = BOLD_BODY_FONT
...
# Phase 2 label
p2_label = p1_total + 2
ws2.cell(row=p2_label, column=1, value='PHASE 2: CPQ, ENRICHMENT & INTEGRATIONS (Weeks 7-14)').font = BOLD_BODY_FONT
