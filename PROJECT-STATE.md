...
|--------|--------|---------------|-------------|----------|
| **Milestone Group** | Active — Wk 1 | Phase 1: Contacts & Activity | Get data exports by Apr 25 | [STATE.md](MilestoneSoW/STATE.md) |
...
- [ ] **Linear not yet created** for Milestone Group — run `MilestoneSoW/create_linear_project.py`
